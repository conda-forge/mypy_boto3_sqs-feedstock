...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mypy_boto3_sqs-feedstock/blob/master/LICENSE.txt)

Summary: Type annotations for boto3.SQS 1.20.46.post1 service, generated by mypy-boto3-builder
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12746&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mypy_boto3_sqs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mypy_boto3_sqs` can be installed with:

```
conda install mypy_boto3_sqs
```

It is possible to list all of the versions of `mypy_boto3_sqs` available on your platform with:
